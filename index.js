...
switch (platform) {
    ...
    switch (arch) {
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'ruspty.android-arm64.node'),
        );
        try {
          if (localFileExisted) {
      ...
      case 'arm':
        localFileExisted = existsSync(
          join(__dirname, 'ruspty.android-arm-eabi.node'),
        );
        try {
          if (localFileExisted) {
  ...
  case 'darwin':
    localFileExisted = existsSync(
      join(__dirname, 'ruspty.darwin-universal.node'),
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'ruspty.darwin-x64.node'),
        );
        try {
          if (localFileExisted) {
